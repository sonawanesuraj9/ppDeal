...
- (instancetype)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
      ...
      //  SVProgressHUDBackgroundColor = [UIColor lightGrayColor];
        SVProgressHUDBackgroundColor = [UIColor colorWithRed:0.93 green:0.92 blue:0.92 alpha:0.9];
        
      //  SVProgressHUDForegroundColor = [UIColor purpleColor];
        SVProgressHUDForegroundColor = [UIColor colorWithRed:0.14 green:0.13 blue:0.13 alpha:1.0];
