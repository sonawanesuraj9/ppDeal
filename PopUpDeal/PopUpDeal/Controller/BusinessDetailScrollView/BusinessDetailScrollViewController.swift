//
//  BusinessDetailScrollViewController.swift
//  BuzzDeal
//
...
class BusinessDetailScrollViewController: UIViewController,UIScrollViewDelegate {

    
//TODO: - General
    let delObj = UIApplication.sharedApplication().delegate as! AppDelegate
    var userID : String = String()
    let bdVC : BusinessDetailViewController = BusinessDetailViewController()
    ...
    func createScroll(){
        ...
        SDImageCache.sharedImageCache().queryDiskCacheForKey(self.imageNameArray[i]) { ( img:UIImage!, cacheType:SDImageCacheType) -> Void in
                if(img != nil){
                    ...
                    print("image in cache")
                    imageView.image =  img //UIImage(named:self.imageNameArray[i])
                    //self.imgProfilePic.image = img
